...
// Parse Images
if (strpos($base_url, 'http://youtube.com') !== false || strpos($base_url, 'http://www.youtube.com') !== false || strpos($base_url, 'http://youtu.be') !== false) {
	$return_array['images'] = array(array('img' => get_youtube_thumbnail($_REQUEST['url']), 'width' => 100));
	$return_array['total_images'] = count(1);
} else {
