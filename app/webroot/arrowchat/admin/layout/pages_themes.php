					...
					<script type="text/javascript">
						$(document).ready(function() {
							$("#add_smiley_name").keyup(function () {
								$("#add_smiley_path").html("themes/{theme name}/images/smilies/" + $(this).val() + ".gif");
							});
						});
					</script>
					<div class="subtitle">Smilies</div>
					<div class="subExplain"><i>The name is also the location of the smiley in the theme's smiley folder.  For example, "smiley-sad" would be found in themes/{theme name}/images/smilies/smiley-sad.gif. Do not enter the extension, all smilies must be .gif.</i></div>
...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="smiley_add" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
					...
					<dl class="selectionBox">
						...
						<dd>
							...
							<p class="explain">
								The name is also the location of the smiley in the theme's smiley folder.  Do not enter the extension, all smilies must be .gif.
							</p>
						</dd>
					</dl>
					<dl class="selectionBox">
						...
						<dd>
							<div id="add_smiley_path" style="min-height: 20px; margin-top: 5px;">themes/{theme name}/images/smilies/.gif</div>
							<p class="explain">
...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="template-data" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
<?php
