...
<div id="wrapper">
	...
	<div id="content">
		<div id="leftcontent">
				{if empty($smarty.get.do) or $smarty.get.do eq 'chatfeatures' or $smarty.get.do eq 'chatsettings'}
				<div class="admin_title_bg"> 
					<ul id ="menu-general"> 
						<li class="navHead">Home</li>
						<li {if empty($smarty.get.do)}class="active_nav"{/if}><a href="./">Overview</a></li> 
				...
				{/if}
				{if $smarty.get.do eq 'banip' or $smarty.get.do eq 'banusernames' or $smarty.get.do eq 'manageusers' or $smarty.get.do eq 'logs' or $smarty.get.do eq 'view'}
				<div class="admin_title_bg"> 
					<ul id ="menu-users"> 
