...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="app_settings_submit" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="add-chatroom" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="chatroom-settings" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
					...
					<dl class="selectionBox submitBox">
						...
						<dd>
							<div class="floatr">
								...
								<input type="hidden" name="chatroom_id" value="<?php echo $row['id']; ?>" />
...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="add-notification" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="add-bar-link" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
