		...
		<?php
			...
			{
		?>
				<div style="margin-top:10px;">We detected that you are using vBulletin.  To get avatars working you will need to upload the file ccpic.php found in the do_not_upload folder to your vBulletin forums root directory.  Then thank FS for including this file so you don't have to hunt it down yourself.</div>
		<?php
			}
		?>
