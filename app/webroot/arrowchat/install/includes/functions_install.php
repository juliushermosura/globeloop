	...
	*/
	function getFinalInstructions($version) 
	{
		switch($version)
		{
			...
			case "elgg":
				return "In Elgg, you can edit the header and footer files by going to the following folder: /views/default/page_elements/.  Then, edit the header.php and footer.php files.";
				break;
			...
			case "ipboard":
				return "In IP.Board, you can edit the header and footer files by going to the IP.Board Admin Panel, clicking Look & Feel and then selecting the skin(s) that you want to add ArrowChat to.  Under Global Templates, select globalTemplate.";
				break;
			...
			case "phpfox":
				return "In PhpFox, you can change the header and footer by going to the following folder: /theme/frontend/default/template/template.html.php (where default is the name of your theme).  You can also disable the PhpFox footer bar in the PhpFox Admin Panel > Settings > System Settings > Manage Settings > Core.";
				break;
