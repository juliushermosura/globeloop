<?php /* Smarty version Smarty 3.1.4, created on 2013-06-12 21:36:57
         compiled from "/Applications/MAMP/htdocs/globeloop/app/webroot/arrowchat/admin/layout/pages_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28661611451b879793fab89-18501852%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3cd1d27898c686db04d146b0f3b2ee9a8b662581' => 
    array (
      0 => '/Applications/MAMP/htdocs/globeloop/app/webroot/arrowchat/admin/layout/pages_header.tpl',
      1 => 1334175600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28661611451b879793fab89-18501852',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51b8797a06144',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51b8797a06144')) {function content_51b8797a06144($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> 
...
<div id="wrapper">
	...
	<div id="content">
		<div id="leftcontent">
				<?php if (empty($_GET['do'])||$_GET['do']=='chatfeatures'||$_GET['do']=='chatsettings'){?>
				<div class="admin_title_bg"> 
					<ul id ="menu-general"> 
						<li class="navHead">Home</li>
						<li <?php if (empty($_GET['do'])){?>class="active_nav"<?php }?>><a href="./">Overview</a></li> 
 ...
 Disabled</b><br />This feature is disabled and will not display in the bar regardless of these settings.  You can enable it under general features.
				...
				<?php }?>
				<?php if ($_GET['do']=='banip'||$_GET['do']=='banusernames'||$_GET['do']=='manageusers'||$_GET['do']=='logs'||$_GET['do']=='view'){?>
				<div class="admin_title_bg"> 
					<ul id ="menu-users"> 
				...
				<?php }?>
				<?php if ($_GET['do']=='adminsettings'||$_GET['do']=='configsettings'||$_GET['do']=='language'||$_GET['do']=='update'||$_GET['do']=='repair'||$_GET['do']=='step1'||$_GET['do']=='step2'||$_GET['do']=='step3'||$_GET['do']=='step5'){?>
				<div class="admin_title_bg"> 
					<ul id ="menu-system"> 
