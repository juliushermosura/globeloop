...
<head>
	...
	<?php
		...
		echo $this->Html->css('directories');
...
<body>
	<div id="container">
		...
		<?php echo $this->element('leftsidebar-directories') ?>
		...
		<div id="content">
			...
			<?php echo '<div id="contentarea"><div class="title">' . $title . '</div>' . $this->fetch('content') . '</div>' ?>
