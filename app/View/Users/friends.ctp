...
<div id="tabs">
  <ul>
    <li><a href="#feeds">Friends Feeds</a></li>
    <li><a href="#list">Friends List</a></li>
  ...
  <div id="feeds">
    <div class="tabContent">
        ...
        <?php echo $this->Html->css('wysihtml5/stylesheet') ?>
        ...
        <?php echo $this->Html->script('wysihtml5/wysihtml5-0.3.0.min') ?>
        <?php echo $this->Html->script('wysihtml5/parser_rules/advanced') ?>
        ...
        <div class="graybar" style="margin-bottom: 30px;">
            ...
            <form>
                ...
                echo $this->Form->textarea('content',array('autofocus' => false, 'spellcheck' => false, 'wrap' => 'off', 'id'=>'postContent','div'=>'false','class'=>'small','label'=>false, 'placeholder' => 'Post something here'));
                ?>
  ...
  <div id="requests">
    <div class="tabContent">
        <?php echo $this->element('friend_requests') ?>
    </div>
  </div>
</div>