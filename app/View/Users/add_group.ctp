...
<?php echo $this->Form->create('Group', array('url' => array('controller' => 'users', 'action' => 'add_group'))) ?>
    <fieldset>
...
<?php echo $this->Form->submit('Save', array('after' => ' ' . $this->Html->link('Cancel', array('controller' => 'users', 'action' => 'groups')))) ?>
